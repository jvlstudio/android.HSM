...
public class Data2Adapter extends BaseAdapter {
	...
	public Data2Adapter(Activity activity, Context context) {
		super();
		...
		for (int i = all.size() - 1; i >= 0; i--) {
			if (all.get(i).day.equals("5 de novembro")) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (palestraAtual.id == null || palestraAtual.id.isEmpty()){
			...
			view = inflater.inflate(R.layout.adapter_data2, parent, false);

			TextView horaInicio = (TextView) view
					.findViewById(R.id.tHorarioInicioD2);
			horaInicio.setText(palestraAtual.hour_init);
	
			TextView horaFinal = (TextView) view.findViewById(R.id.tHorarioFimD2);
			horaFinal.setText(palestraAtual.hour_final);
	
			TextView nome = (TextView) view
					.findViewById(R.id.tNomePalestranteD2);
			nome.setText(palestraAtual.author);
			
			TextView subtitle = (TextView) view.findViewById(R.id.tTipoPalestraD2);
			subtitle.setText(palestraAtual.subtitle);
	
			ImageView imagem = (ImageView) view
					.findViewById(R.id.imgPalestranteAgendaD2);
