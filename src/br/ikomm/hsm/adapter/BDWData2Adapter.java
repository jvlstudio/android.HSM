...
public class BDWData2Adapter extends BaseAdapter {

	private Context context;
	private LayoutInflater inflater;
	private List<PalestraBDW> palestrasBDW = new ArrayList<PalestraBDW>();

	public BDWData2Adapter(Activity activity, Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (palestraAtual.type.equals("break")) {
			...
			view = inflater.inflate(R.layout.adapter_bdwdata2, parent, false);

			TextView horaInicio = (TextView) view
					.findViewById(R.id.tHorarioInicioD2);
			horaInicio.setText(palestraAtual.hour_init);
			TextView horaFinal = (TextView) view
					.findViewById(R.id.tHorarioFimD2);
			horaFinal.setText(palestraAtual.hour_final);
			...
			TextView sub = (TextView) view.findViewById(R.id.tTipoPalestraD2);
